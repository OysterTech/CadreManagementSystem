...
CREATE TABLE `archive` (
  ...
  `dep_status` varchar(10) COLLATE utf8_unicode_ci NOT NULL DEFAULT '2|',
...
(4, 1, '育才中学社团联盟', '2018-11-19 05:12:04', '2018-11-19 05:12:04'),
(5, 3, '团委团务部', '2018-11-02 23:58:38', '2018-11-02 23:58:38'),
(6, 3, '团委新闻部', '2018-11-18 16:00:00', '2018-11-18 16:00:00'),
(7, 3, '团委组织部', '2018-11-19 05:08:30', '2018-11-19 05:08:30'),
(8, 4, '社联宣传部', '2018-11-19 05:09:03', '2018-11-19 05:09:03'),
(9, 4, '社联策划部', '2018-11-19 05:09:03', '2018-11-19 05:09:03'),
(10, 2, '学生会秘书处', '2018-11-19 10:42:54', '2018-11-19 10:42:54'),
(11, 2, '学生会外联部', '2018-11-19 10:42:54', '2018-11-19 10:42:54'),
(12, 2, '学生会宣传部', '2018-11-19 10:42:54', '2018-11-19 10:42:54'),
(13, 2, '学生会策划部', '2018-11-19 10:42:54', '2018-11-19 10:42:54');
...
(6, 1, '数据库后台', 'database', 'show/jumpout/https%3A%2F%2Fwww.xshgzs.com%2FdbAdmin', '2018-02-18 04:46:23', '2018-03-15 13:11:57'),
...
(19, 0, '个人档案管理', 'address-card', '', '2018-10-24 12:50:18', '2018-11-15 07:15:11'),
(20, 19, '我的档案', 'user-circle', 'archive/myCard', '2018-10-24 12:51:19', '2018-11-04 11:47:24'),
(21, 19, '部员的档案', 'users', 'archive/myMember', '2018-10-24 12:53:59', '2018-11-04 11:47:07'),
(22, 0, '奖惩管理（开发中）', 'trophy', '', '2018-10-25 12:52:43', '2018-11-18 17:23:33'),
...
(7, '主席', '学生会主席/团委副书记/社联秘书长', 0, '2018-10-25 13:12:19', '2018-11-20 21:11:12'),
(8, '部长', '各部门部长', 0, '2018-10-25 13:12:31', '0000-00-00 00:00:00'),
(9, '成员', '普通基层成员', 1, '2018-10-25 13:12:56', '0000-00-00 00:00:00'),
(10, '退休老干部', '已退休老干部，仅能回看记录', 0, '2018-11-19 10:44:23', '0000-00-00 00:00:00');
...
CREATE TABLE `work_log` (
  ...
  `photo_url` text COLLATE utf8_unicode_ci,
  `begin_time` varchar(19) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0000-00-00 00:00:00',
  `end_time` varchar(19) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0000-00-00 00:00:00',
  `work_hour` varchar(3) COLLATE utf8_unicode_ci NOT NULL DEFAULT '0',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
