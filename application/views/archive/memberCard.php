...
<head>
  ...
  <title>部员档案编辑 / <?php echo $this->Setting_model->get('systemName'); ?></title>
</head>
...
<div class="row">
	<div class="col-lg-12">
		<h1 class="page-header"><?=$info['name'];?>的档案</h1>
	</div>
</div>
<!-- ./Page Name-->
...
function updateArchive(){
	...
	$.ajax({
		url:"<?=base_url('archive/toEditMember');?>",
		type:"post",
		data:{<?=$this->ajax->showAjaxToken();?>,'name':name,"phone":phone,"enrollYear":enrollYear,"classNum":classNum,"description":description,"photoUrl":photoUrl,'depId':depId,'jobName':jobName},
		dataType:'json',
		error:function(e){
